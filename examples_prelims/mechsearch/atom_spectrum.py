...
class AtomSpectrum:
    def __init__(self, vertices: Iterable[Union[mod.GraphVertex, mod.RuleLeftGraphVertex]]):
    ...
    def _add_vertex(self, vertex: Union[mod.GraphVertex, mod.RuleLeftGraphVertex]):
