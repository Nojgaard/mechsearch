...
def _rule_graph_to_networkx(rule_graph: Union[mod.RuleLeftGraph, mod.RuleRightGraph]) -> networkx.Graph:
...
def _get_rule_graphs(rule_graph: Union[mod.RuleLeftGraph, mod.RuleRightGraph]) -> Iterator[str]:
...
class Grammar:
    def __init__(self, printer: mod.GraphPrinter = mod.GraphPrinter()):
        ...
        self._atom_id_map: Dict[mod.GraphVertex, int] = {}
